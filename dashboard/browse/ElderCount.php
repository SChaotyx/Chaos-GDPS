...
*/
$modtable = "";
$accounts = implode(",",$gs->getAccountsWithPermission("elderCommands"));
if($accounts == ""){
	$dl->printBox(sprintf($dl->getLocalizedString("errorNoAccWithPerm"), "Elder Moderator"));
	exit();
}
...
foreach($result as &$mod){
 ...
 foreach($result2 as &$mod2){
	...
	$modtable .= "<tr><th scope='row'>".$row."</th><td>".$mod["userName"]."</td><td>".$lvlcount."</td><td>".$time."</td></tr>";
}
